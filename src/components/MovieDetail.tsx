    ...
    <div className="space-y-8">
      ...
      <div className="flex flex-col md:flex-row gap-8">
        ...
        <div className="flex-1">
          ...
          {movie.description && <p className="text-gray-400 mt-2">{movie.description}</p>}

          {movie.trailerUrl && (
            <div className="mt-6">
              <h2 className="text-lg font-bold mb-3">Трейлер</h2>
              ...
              <div key={v.userId} className="flex items-center gap-3">
                ...
                <div className="flex gap-0.5">
                  {Array.from({ length: 10 }, (_, i) => (
                    <div
                      key={i}
                      className={`w-3 h-3 rounded-sm ${i < v.rating ? "bg-amber-400" : "bg-gray-800"}`}
                    />
                  ))}
                </div>
      ...
      <div className="bg-gray-900 border border-gray-800 rounded-xl p-6">
        ...
        <div className="flex flex-wrap items-center gap-4">
          ...
          <button
            onClick={handleVote} disabled={!currentUser}
      ...
      <div className="bg-gray-900 border border-gray-800 rounded-xl p-6">
        ...
        <div className="space-y-4 mb-6">
          {movie.comments.length === 0 && <p className="text-gray-500">Ще немає коментарів</p>}
        ...
        <div className="flex gap-3">
          ...
          />
          <button
            onClick={handleComment} disabled={!currentUser || !commentText.trim()}
            className="bg-amber-400 text-gray-900 px-6 py-2 rounded-lg font-medium hover:bg-amber-300 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
          >
            Надіслати
          </button>
